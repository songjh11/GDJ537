	            		...
	            		<div class="card-header bg-white">
	            			<div class="row">
	            				<div class="col-auto align-self-center">
				                  <h5 class="mb-0 text-gray-800" data-anchor="data-anchor" id="file-input">공지사항 작성</h5>
				                  <div class="alt-option"></div>
				                  <p class="mb-0 pt-1 mt-2 mb-0">공지사항 작성 페이지입니다.</p>
				                </div>
				             </div>
				         </div>
				         <div class="card-body">
				         	<form action="./add" method="post" enctype="multipart/form-data">
				                <div class="mb-0 row">
								  	...
								  	<div class="col-sm-10">
								  		<input class="form-control-plaintext outline-none" id="id" name="id" type="text" value="1234" disabled="disabled"/>
								  	</div>
								</div>
								<div class="mb-3 row">
								...
								<div>
								  <div class="custom-file">
									  <input type="file" class="custom-file-input" style="" id="customFileLang" lang="es">
