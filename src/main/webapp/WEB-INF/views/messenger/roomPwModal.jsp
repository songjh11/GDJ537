									...
									<div class="pwModal-window">
										...
										<div class="content">
											<div class="pwModalInfo">
												<div class="pwInfoArea" style="background: transparent; border: none; box-shadow: none !important;">
													...
													<div class="input-group has-validation mb-3 justify-content-center">
														<div class="form-floating is-invalid">
														  ...
														  <input type="password" id="roomPwCheck" name="pw" class="form-control" placeholder="숫자를 입력해 주세요" required>
													...
													<p class="mt-4">
														...
														<input type="button" value="확인" id="pwCheckBtn" class="btn" style="background: #4e73df; color: #FFFFFF;">
													</p>
												</div>
											</div>
										</div>
